...
namespace VeterinaryClinicDatabase {
    ...
    public partial class ClientDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientDataTable : global::System.Data.TypedTableBase<ClientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClientRow AddClientRow(string First_Name, string Last_Name, string email) {
...
namespace VeterinaryClinicDatabase.ClientDataSetTableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Client] WHERE (([client_id] = @Original_ID) AND ([first_name] = @Ori" +
                "ginal_First_Name) AND ([last_name] = @Original_Last_Name) AND ((@IsNull_email = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Client] ([first_name], [last_name], [email]) VALUES (@First_Name, @L" +
                "ast_Name, @email);\r\nSELECT client_id AS ID, first_name AS [First Name], last_nam" +
                "e AS [Last Name], email FROM Client WHERE (client_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Client] SET [first_name] = @First_Name, [last_name] = @Last_Name, [email] = @email WHERE (([client_id] = @Original_ID) AND ([first_name] = @Original_First_Name) AND ([last_name] = @Original_Last_Name) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));
SELECT client_id AS ID, first_name AS [First Name], last_name AS [Last Name], email FROM Client WHERE (client_id = @client_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        client_id AS ID, first_name AS [First Name], last_name AS [Last Nam" +
                "e], email\r\nFROM            Client";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        client_id AS ID, first_name AS [First Name], last_name AS [Last Nam" +
                "e], email\r\nFROM            Client\r\nWHERE        (first_name LIKE \'%\' + @ClientNa" +
                "meParam + \'%\') OR\r\n                         (last_name LIKE \'%\' + @ClientNamePar" +
                "am + \'%\')";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ClientNameParam", global::System.Data.SqlDbType.VarChar, 32, global::System.Data.ParameterDirection.Input, 0, 0, "First Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByClientName(ClientDataSet.ClientDataTable dataTable, string ClientNameParam) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((ClientNameParam == null)) {
                throw new global::System.ArgumentNullException("ClientNameParam");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(ClientNameParam));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual int Update(string First_Name, string Last_Name, string email, int Original_ID, string Original_First_Name, string Original_Last_Name, string Original_email, int client_id) {
            if ((First_Name == null)) {
                throw new global::System.ArgumentNullException("First_Name");
            }
            else {
