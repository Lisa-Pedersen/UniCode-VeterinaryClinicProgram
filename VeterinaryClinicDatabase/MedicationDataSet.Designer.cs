...
namespace VeterinaryClinicDatabase.MedicationDataSetTableAdapters {
    ...
    public partial class MedicationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Medication] WHERE (([med_id] = @Original_med_id) AND ([med_nam" +
                "e] = @Original_med_name) AND ((@IsNull_units = 1 AND [units] IS NULL) OR ([units" +
                "] = @Original_units)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Medication] ([med_name], [units]) VALUES (@med_name, @units);\r" +
                "\nSELECT med_id, med_name, units FROM Medication WHERE (med_id = SCOPE_IDENTITY()" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Medication] SET [med_name] = @med_name, [units] = @units WHERE (([med_id] = @Original_med_id) AND ([med_name] = @Original_med_name) AND ((@IsNull_units = 1 AND [units] IS NULL) OR ([units] = @Original_units)));
SELECT med_id, med_name, units FROM Medication WHERE (med_id = @med_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT med_id, med_name, units FROM dbo.Medication";
        ...
        public virtual int Fill(MedicationDataSet.MedicationDataTable dataTable) {
        ...
        public virtual MedicationDataSet.MedicationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MedicationDataSet.MedicationDataTable dataTable = new MedicationDataSet.MedicationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MedicationDataSet.MedicationDataTable dataTable) {
