...
namespace VeterinaryClinicDatabase.StaffDataSetTableAdapters {
...
SELECT staff_id, first_name, last_name, staff_role FROM Staff WHERE (staff_id = @staff_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        staff_id, first_name, last_name, staff_role\r\nFROM            Staff\r" +
                "\nWHERE        (first_name LIKE \'%\' + @staffNameParam + \'%\') OR\r\n                " +
                "         (last_name LIKE \'%\' + @staffNameParam + \'%\')";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@staffNameParam", global::System.Data.SqlDbType.VarChar, 32, global::System.Data.ParameterDirection.Input, 0, 0, "first_name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        staff_id, first_name, last_name, staff_role\r\nFROM            Staff\r" +
        ...
        public virtual int FillByStaffName(StaffDataSet.StaffDataTable dataTable, string staffNameParam) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((staffNameParam == null)) {
                throw new global::System.ArgumentNullException("staffNameParam");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(staffNameParam));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillOnlyVeterinarians(StaffDataSet.StaffDataTable dataTable) {
